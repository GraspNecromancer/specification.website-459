...
```bash
git clone https://github.com/GraspNecromancer/specification.website-459.git
cd specification.website-459
npm install
npm start
```


[![CI](https://github.com/GraspNecromancer/specification.website-459/actions/workflows/ci.yml/badge.svg)](https://github.com/GraspNecromancer/specification.website-459/actions/workflows/ci.yml)
...
<!-- Last updated: 2026-06-06 17:26:24 -->
